...
const translations = {
  sw: {
    ...
    groups: 'Vikundi',
    toggleLang: 'EN',
    searchPlaceholder: 'Tafuta mazao, wauzaji, ushauri...',
    overview: 'Muhtasari',
    marketplace: 'Soko la Mazao',
    education: 'Elimu ya Kilimo',
    forum: 'Jukwaa',
    chat: 'Mazungumzo',
    settings: 'Mipangilio',
    help: 'Msaada',
    ...
    myAdvice: 'Ushauri Wangu',
    myMessages: 'Ujumbe Wangu',
    weatherForecast: 'Utabiri wa Hali ya Hewa',
    priceTrend: 'Mwelekeo wa Bei',
    farmerGroups: 'Vikundi vya Wakulima',
    buyInputs: 'Nunua Viingilio',
    extensionServices: 'Huduma za Mtaalamu',
    wallet: 'Mkoba wa Malipo',
  },
  en: {
    home: 'Home',
    market: 'Market',
    ...
    groups: 'Groups',
    toggleLang: 'SW',
    searchPlaceholder: 'Search crops, sellers, advice...',
    overview: 'Overview',
    marketplace: 'Marketplace',
    education: 'Farm Education',
    forum: 'Forum',
    chat: 'Chat',
    settings: 'Settings',
    help: 'Help',
